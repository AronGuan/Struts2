package manning.chapterThree.utils;
...
public class PortfolioService  {
	...
	/*  At this point the application doesn't actually associate the images with a portfolio.  This just saves the file to the 
	 *  application's root filesystem */
	...
	public User authenticateUser(String username, String password) {
		...
		/* Retrive a user object.
		 * We're building a copy so that it mirrors the behaviour of the peristence backed object.
		 */
